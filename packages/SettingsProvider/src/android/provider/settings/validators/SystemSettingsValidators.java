...
public class SystemSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(System.STATUS_BAR_BATTERY_STYLE, new InclusiveIntegerRangeValidator(0, 21));
        ...
        VALIDATORS.put(System.STATUS_BAR_CLOCK_DATE_POSITION, new InclusiveIntegerRangeValidator(0, 1));
        VALIDATORS.put(System.STATUS_BAR_CLOCK_DATE_DISPLAY, new InclusiveIntegerRangeValidator(0, 2));
